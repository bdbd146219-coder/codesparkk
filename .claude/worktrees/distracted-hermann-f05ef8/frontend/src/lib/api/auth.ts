...
// (via the shared `Op<>` helper) so the frontend never duplicates them.
// Backend changes that affect these surfaces become compile errors on the
// next `npm run gen:api-types`.
