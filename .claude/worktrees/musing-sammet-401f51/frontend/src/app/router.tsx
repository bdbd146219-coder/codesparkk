...
import {
  ...
  LearningPathDetailPlaceholder,
  LearningPathNewPlaceholder,
  LearningPathsPlaceholder,
} from '@/features/staff/catalog/pages';
    ...
    <Routes>
      ...
      <Route path="/staff" element={<StaffShell />}>
        ...
        <Route element={<RequireStaff />}>
          ...
          <Route path="learning-paths" element={<LearningPathsPlaceholder />} />
          <Route path="learning-paths/new" element={<LearningPathNewPlaceholder />} />
          <Route path="learning-paths/:id" element={<LearningPathDetailPlaceholder />} />
        </Route>
      </Route>
