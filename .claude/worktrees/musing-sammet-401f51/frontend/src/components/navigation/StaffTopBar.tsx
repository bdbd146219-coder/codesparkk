...
import { filterGroups, filterItems, staffNav, type NavConfig } from '@/lib/navigation';
...
export function StaffTopBar() {
  ...
  const nav: NavConfig = {
    primary: filterGroups(staffNav.primary, role),
    utility: filterItems(staffNav.utility ?? [], role),
  };
