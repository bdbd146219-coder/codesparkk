...
const MATRIX = [
  ...
  // Interest leads (C4O) — admin follow-up queue. `?state=` fixtures render the
  // list (with staff notes + a paginated view), empty, error, and loading.
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'en', viewport: 'desktop', devAuth: true, devRole: 'admin', state: 'populated' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'en', viewport: 'tablet', devAuth: true, devRole: 'admin', state: 'populated' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'en', viewport: 'mobile', devAuth: true, devRole: 'admin', state: 'populated' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'en', viewport: 'desktop', devAuth: true, devRole: 'admin', state: 'paginated' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'en', viewport: 'desktop', devAuth: true, devRole: 'admin', state: 'empty' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'en', viewport: 'desktop', devAuth: true, devRole: 'admin', state: 'error' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'en', viewport: 'desktop', devAuth: true, devRole: 'admin', state: 'loading' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'ar', viewport: 'desktop', devAuth: true, devRole: 'admin', state: 'populated' },
  { route: '/staff/catalog/interests', theme: 'staff', lng: 'ar', viewport: 'mobile', devAuth: true, devRole: 'admin', state: 'populated' },
